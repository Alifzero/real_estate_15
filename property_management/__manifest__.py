# -*- coding: utf-8 -*-
{
    ...
    'data': [
        ...
        'views/templates.xml',
        'views/sequence.xml',
        'reports/real_estate_header_footer.xml',
        'reports/real_estate_reports.xml',
        'reports/allocation_letter.xml',
        'reports/confirmation_letter.xml',
        'reports/possesion_letter.xml',
        'reports/provisional_allotment.xml'
        # 'views/member.xml',
    ],
    'qweb': [
